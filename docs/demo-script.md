...
| 2:55–3:20 | **The ledger.** Right pane: **32.4 kB banded forward, 2 bytes back, 0 B of record content, 2 rounds.** "Zero is by construction: the protocol has no field that can carry a record. And the model's reasoning stayed on the firm's node; what crossed the wire was requirement-side vocabulary." | driver |
